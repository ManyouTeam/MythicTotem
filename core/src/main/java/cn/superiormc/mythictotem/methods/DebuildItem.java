...
public class DebuildItem {
    ...
    public static ConfigurationSection debuildItem(ItemStack itemStack, ConfigurationSection section) {
        ...
        if (MythicTotem.methodUtil.methodID().equals("paper") &&
            ...
            section.set("component", MythicTotem.methodUtil.serializeItemStack(itemStack));
        } else {
            ...
            if (meta.hasDisplayName()) {
                section.set("name", MythicTotem.methodUtil.getItemName(meta));
            }

            // Item Name
            if (CommonUtil.getMinorVersion(20, 5)) {
                if (meta.hasItemName()) {
                    section.set("item-name", MythicTotem.methodUtil.getItemItemName(meta));
                }
            }

            // Lore
            if (meta.hasLore()) {
                section.set("lore", MythicTotem.methodUtil.getItemLore(meta));
            }
            ...
            if (meta instanceof SkullMeta) {
                ...
                String textureValue = MythicTotem.methodUtil.serializeSkull(skullMeta);
