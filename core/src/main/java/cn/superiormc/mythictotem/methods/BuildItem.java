...
import cn.superiormc.mythictotem.utils.NBTUtil;
    ...
    public static ItemStack editItemStack(ItemStack item,
        ...
        if (materialKey != null) {
            ...
            if (pluginName != null && itemID != null) {
                ...
                item = MythicTotem.methodUtil.getItemObject(itemThing);
            }
        }
        ...
        if (displayNameKey != null) {
            MythicTotem.methodUtil.setItemName(meta, CommonUtil.modifyString(player, displayNameKey, args), player);
        }
        ...
        if (CommonUtil.getMinorVersion(20, 5)) {
            ...
            if (itemNameKey != null) {
                MythicTotem.methodUtil.setItemItemName(meta, CommonUtil.modifyString(player, itemNameKey, args), player);
            }
        }
        ...
        if (!lores.isEmpty()) {
            MythicTotem.methodUtil.setItemLore(meta, CommonUtil.modifyList(player, lores, args), player);
        }
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (skullTextureNameKey != null) {
                ...
                if (skullTextureNameKey.length() > 16) {
                    MythicTotem.methodUtil.setSkullMeta(skullMeta, skullTextureNameKey);
                } else {
        ...
        if (meta instanceof BlockStateMeta) {
            ...
            if (state instanceof CreatureSpawner) {
                ...
                if (spawnerKey != null) {
                    ...
                    if (MythicTotem.methodUtil.methodID().equals("paper") && CommonUtil.getMinorVersion(20, 5) && entityType == EntityType.ITEM) {
        ...
        if (CommonUtil.getMinorVersion(21, 2)) {
            ...
            if (!MythicTotem.freeVersion && equippable != null) {
        ...
        if (componentKey != null) {
            item = MythicTotem.methodUtil.editItemStack(item, player, componentKey, -1, args);
        }
        ...
        if (!MythicTotem.freeVersion && nbtSection != null && CommonUtil.checkPluginLoad("NBTAPI")) {
